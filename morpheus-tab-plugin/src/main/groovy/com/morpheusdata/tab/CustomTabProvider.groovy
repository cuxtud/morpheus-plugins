...
class CustomTabProvider extends AbstractInstanceTabProvider {
	...
	*/
	...
	TabContentSecurityPolicy getContentSecurityPolicy() {
		def tcsp = new TabContentSecurityPolicy()
		tcsp.scriptSrc = '*.jsdelivr.net'
		tcsp.frameSrc = '*.google.com'
		tcsp.imgSrc = '*.wikimedia.org'
		tcsp.styleSrc = 'https: *.bootstrapcdn.com'
		tcsp
	}
	*/
}
